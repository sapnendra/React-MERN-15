  ...
  return (
    <div className='border border-gray-700 rounded-4xl mt-10 flex items-center justify-center'>
        <div className="w-1/2 px-15 py-30 flex flex-col gap-6">
            <h1 className='text-6xl font-bold bg-linear-to-r from-amber-400 to-amber-600 text-transparent bg-clip-text'>Contact Page Routing</h1>
            <h2 className='mb-10 text-4xl text-gray-500 font-semibold'>React Router DOM</h2>
        ...
        <div className="w-1/2 flex flex-col gap-6">
            <div className="h-full w-full flex items-center justify-center">
                <img className='h-130 w-130' src="/contact.svg" alt="" />
            </div>
        </div>
    </div>
  )
